...
{
    public class LogicRunnerForGetTweetsAndSentimentsAndStorage
    {
        ...
        public LogicRunnerForGetTweetsAndSentimentsAndStorage(ICandidates candidateRepo, 
        ...
        public  async Task GetTweetsPerformSentimentAndStorageMethodRunner()
        {
